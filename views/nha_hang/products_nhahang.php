<div class='container'>
    <div class='row'>
        <div class='col-2 p-0 m-0 btn_selects_products_nhahang'>
            ...
            <button class='tablink_btn_selects_products_nhahang' id='btn_products_nhahang_spmoi'>Sản phẩm mới</button>
        ...
        <div class='col-10'>
            <div class='tabcontent_products_nhahang' id='tatca_products_nhahang'>
                <div class='row'>
                    <div class='col-3 item_card_trangchu'>
                        <div class='card'>
                            <img src='../asset/img/laviet.jpg' class='card-img-top' alt='https://via.placeholder.com/150'>
                            <div class='card-body'>
                                <p class='py-3'>Cold Brew Dâu Tằm và cà phê sữa</p>
                                <div class='content_card_trangchu py-2'>
                                ...
                                <button href='#' class='w-100 mt-2 btn btn-primary'>Thêm vào giỏ hàng</button>
                            </div>
                        </div>
                    </div>
                    <div class='col-3 item_card_trangchu'>
            ...
            <div class='tabcontent_products_nhahang' id='new_products_nhahang'></div>
            <div class='tabcontent_products_nhahang' id='hot_products_nhahang'></div>
            <div class='tabcontent_products_nhahang' id='bestseller_products_nhahang'></div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function(){
        ...
        $("#btn_products_nhahang_spmoi").click(function() {
            show_products_nhahang("btn_products_nhahang_spmoi","new_products_nhahang")
